...
// --- 1. 假数据 (Mock Data) Pro Max 版 ---
const mockDatabase = [
    // 🔍 百度全家桶
    "百度地图", "百度网盘", "百度翻译", "百度贴吧", "百度文库", "百度知道",
    
    // 💻 前端内卷专区
    "前端开发教程", "Vite 构建工具", "Vue3 入门", "React 和 Vue 哪个好找工作",
    "JavaScript 高级程序设计", "Vue 3 实战项目", "React Hooks 指南", 
    "CSS 居中也是一种玄学", "JavaScript 闭包怎么理解", "TypeScript 要不要学",
    "Node.js 服务端开发", "Webpack 配置详解", "Next.js 服务端渲染",
    
    // 🤖 AI 与 热门科技
    "ChatGPT vs DeepSeek", "AI 绘画工具", "Python 数据分析", "如何用 AI 写周报",
    "NVIDIA 显卡价格", "鸿蒙系统开发", "Java 还是 Go",
    
    // 🎮 摸鱼与游戏
    "黑神话：悟空 攻略", "原神启动", "塞尔达传说", "Steam 促销时间",
    "Switch 游戏推荐", "英雄联盟全球总决赛",
    
    // 🍜 吃喝玩乐 & 生活
    "今天天气怎么样", "如何制作红烧肉", "附近的美食推荐", "奶茶热量高吗",
    "北京环球影城攻略", "高铁票怎么抢", "最近上映的电影",
    "感冒了喝热水有用吗", "西红柿炒蛋先放蛋还是先放西红柿",
    
    // 🤔 灵魂发问 (模拟真实用户的奇怪搜索)
    "猫咪为什么一直盯着我看", "如何快速暴富", "头发掉得厉害怎么办",
    "世界上真的有奥特曼吗", "熬夜会变傻吗", "为什么周一这么漫长",
    "Baidu Search Demo", "Hello World"
];
